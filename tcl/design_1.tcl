...
\
  ...
  connect_bd_net -net full_radio_0_m_axis_tdata [get_bd_pins full_radio_0/m_axis_tdata] [get_bd_pins lowlevel_dac_intfc_0/data_word] [get_bd_pins axi_fifo_mm_s_0/axi_str_rxd_tdata]
  connect_bd_net -net full_radio_0_m_axis_tvalid [get_bd_pins full_radio_0/m_axis_tvalid] [get_bd_pins lowlevel_dac_intfc_0/valid] [get_bd_pins axi_fifo_mm_s_0/axi_str_rxd_tvalid]
  ...
  connect_bd_net -net s00_axi_aclk_0_1 [get_bd_ports clk125] [get_bd_pins full_radio_0/s00_axi_aclk] [get_bd_pins lowlevel_dac_intfc_0/clk125] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins xpm_cdc_gen_0/dest_clk] [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M01_ACLK]
  connect_bd_net -net xpm_cdc_gen_0_dest_rst_out [get_bd_pins xpm_cdc_gen_0/dest_rst_out] [get_bd_pins full_radio_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins lowlevel_dac_intfc_0/resetn] [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M01_ARESETN]
